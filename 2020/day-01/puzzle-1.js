...
let iterations = 0;
let firstNumber = null; /* 976 */
let secondNumber = null; /* 1044 */
...
function firstApproach() {
    ...
    console.log(iterations, firstNumber, secondNumber, firstNumber*secondNumber);
}
...
function thirdApproach() {
    ...
    try {
        input.forEach(first => {
            let separatedIndex = 10 - first%10;
            if (separatedIndex == 10) {
                separatedIndex = 0;
            }
            separatedInput[separatedIndex].forEach(second => {
                iterations++;
                if (first + second == targetSum) {
                    firstNumber = first;
                    secondNumber = second;
...
/* firstApproach(); 40000 iterations */
/* secondApproach(); 6960 iterations */
thirdApproach(); /* 899 iterations */