...
function firstApproach() {
    input.forEach(line => {
        let policy, policyPositions, policyFirstPosition, policySecondPosition, policyChar, password;
        [policy, password] = line.split(": ");
        [policyPositions, policyChar] = policy.split(" ");
        [policyFirstPosition, policySecondPosition] = policyPositions.split("-");

        policyFirstPosition--;
        policySecondPosition--;

        let matchCount = 0;
        if (password[policyFirstPosition] == policyChar) {
            matchCount++;
        }
        if (password[policySecondPosition] == policyChar) {
            matchCount++;
        }
